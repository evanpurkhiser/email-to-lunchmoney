...
const billedCases = [
  {
    ...
    expected: {
      type: 'update',
      match: {expectedPayee: 'Chase Travel', expectedTotal: 33850},
  ...
  },
  {
    ...
    expected: {
      type: 'update',
      match: {expectedPayee: 'Chase Travel', expectedTotal: 6293},
  ...
  },
  {
    ...
    expected: {
      type: 'update',
      match: {expectedPayee: 'Chase Travel', expectedTotal: 9829},
